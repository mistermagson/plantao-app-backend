...
let juizes = [
    ...
    { id: 2, nome: "Dr. XNice" , dataAntiguidade:"2020-01-01"},
    { id: 3, nome: "Dr. BNice" , dataAntiguidade:"2019-01-01"},
    { id: 4, nome: "Dr. CNice" , dataAntiguidade:"2018-01-01"},
    { id: 5, nome: "Dr. DNice" , dataAntiguidade:"2017-01-01"},
    { id: 6, nome: "Dr. ENice" , dataAntiguidade:"2016-01-01"},
    { id: 7, nome: "Dr. FNice" , dataAntiguidade:"2021-01-01"}
];

server.get("/juizes/:id", (req, res) => {
...
server.get("/juizes", (req, res) => {

    return res.json(juizes);
});

server.post("/juizes", (req, res)=>{
...
server.delete("/juizes/:id", (req,res)=>{
    const {id} = req.params;
